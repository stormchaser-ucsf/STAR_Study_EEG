...
fprintf('trace sigma_T = %.6e\n', trace(sigma_T));
fprintf('trace sigma_N = %.6e\n', trace(sigma_N));
fprintf('trace sigma_C = %.6e\n', trace(sigma_C));
fprintf('max trace diff = %.6e\n', max(abs([trace(sigma_T), trace(sigma_N), trace(sigma_C)] - trace(sigma_T))));
