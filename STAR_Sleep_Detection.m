...
subject_names={'24011','24012','24014','24015','24016','24017','24018','24019','24020',...
...
participant_name ='24011';
filename=  [participant_name '_SleepStages'];
%filepath = 'F:\DATA\EEG Data Anne Richards\STAR\Phase 2\Participant 24012\Sleep Stage Report';
filepath = ['/media/user/Data/Ana EEG/STAR/Phase 2/Participant ' participant_name ...
    '/Sleep Stage Report/'];
filename = fullfile(filepath,filename);
sleep_profile = table2array(importfile_sleep(filename,'Data',[3, Inf]));
figure;plot(sleep_profile)
...
%% GET PREFERRED SPINDLE FREQUENCY PER CHANNEL BY SPEEP STAGE   
...
I = sleep_staging>0;
grid_sp = detect_spindles(data(1:64,:),I,soFilt,spFilt1,spFilt2,sleep_staging,Fs,slow_fast_idx);
